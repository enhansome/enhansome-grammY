...
This is a curated list of projects that are using grammY. Anyone is welcome to to add their projects following the [Contribution Guildlines](https://github.com/grammyjs/awesome-grammY/blob/main/CONTRIBUTING.md) ⭐ 277 | 🐛 4 | 📅 2026-07-27.
...
* [IgorShadurin/weight-telegram-bot](https://github.com/IgorShadurin/weight-telegram-bot) ⭐ 1 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-08 - Track photo-backed weekly weight goals in groups with charts, reminders, 53 achievements, and nine natural localizations. [ᴜsᴇ](https://t.me/my_weight_goal_bot).
* [DeltaUniverse/peerUser](https://github.com/DeltaUniverse/peerUser) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-30 - Auto-Delete Incoming Private Messages. [ᴜsᴇ](https://t.me/peerUserbot)
...
* [waptik/grammy-on-deta-template](https://github.com/waptik/grammy-on-deta-template) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2022-08-09 - A template to start a grammY bot and deploy it on [Deta](https://www.deta.sh). [ᴜsᴇ](https://t.me/GrammyOnDetaBot)
* [xditya/GrammyCloneableBot](https://github.com/xditya/GrammyCloneableBot) ⭐ 14 | 🐛 0 | 🌐 TypeScript | 📅 2022-12-11 - A template for bots that can be cloned.
...
* [VDS13/telegram-inline-calendar](https://github.com/VDS13/telegram-inline-calendar) ⭐ 110 | 🐛 1 | 🌐 JavaScript | 📅 2025-03-26 - Date picker and inline calendar for your bots.
